(function(w){
 ...
 function create(report){
  ...
  function reset(keepScene){music=null;policy=null;cancelAnimationFrame(frame);frame=0;Array.from(tracks.keys()).forEach(function(a){var r=tracks.get(a);if(keepScene&&r.key==='scene'){r.fade=null;a.volume=target(r);}else remove(a);});}
