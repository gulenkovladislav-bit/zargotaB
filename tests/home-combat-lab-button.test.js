...
assert.match(html, /if\(mode!=='magic'&&mode!=='story'&&settings&&!settings\.classList\.contains\('open'\)&&w\.zgGameSettings\)w\.zgGameSettings\(\)/, 'combat and free-room workshop modes should expose their controls immediately without covering the magic or story palettes');
