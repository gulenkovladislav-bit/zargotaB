(function (root, factory) {
  ...
  var FOUNDATION_ITEMS = [
    ...
    },
    {
      ...
      name:'Набор скалолаза', icon:'🧗', image:'images/shop/cliff-climber-kit.png', imgSize:'square',
      cat:'tool', category:'tool', slot:'utility', handsRequired:0, tags:['climbing','rope','travel'],
      rarity:'uncommon', powerTier:1, recommendedLevel:{min:1,max:6},
      access:{markets:['city','guild'],legality:'open'}, price:{pl:0,zl:8,sr:0,md:0},
      effect:'+2 к подготовленному подъёму · страховка требует точки крепления',
      effects:[{id:'prepared-climb',type:'world',trigger:'climb',operation:'check-bonus',value:2,condition:'kit-anchored-before-climb',frequency:'scene',stacking:'highest'}],
      desc:'Верёвка, кожаная обвязка, молоток и три железных крюка. Подъём становится медленнее, но ошибка перестаёт быть приговором.'
    },
    {
  ...
  var CRAFTING_COMPONENT_ITEMS = [
    ...
    item.effect = 'Компонент ' + item.crafting.grade + ' качества · ' + item.crafting.affinities.join(', ');
