(function (root, factory) {
  ...
  var FOUNDATION_ITEMS = [
    ...
    },
    {
      ...
      effect:'Преимущество при сборе и распознавании природных припасов · защищает одежду и образцы от сырости',
      effects:[{id:'mushroom-gathering',type:'world',trigger:'gather-or-identify-natural-supplies',operation:'grant-advantage',value:1,condition:'fungi-herbs-roots-or-other-wild-supplies',frequency:'passive',stacking:'highest'}],
    ...
    },
    {
      ...
      effect:'Преимущество при поиске человека, адреса или открытого городского маршрута · узнаваемый служебный вид',
      effects:[{id:'find-addressee',type:'world',trigger:'search-person-address-or-route',operation:'grant-advantage',value:1,condition:'inside-populated-settlement',frequency:'passive',stacking:'highest'}],
    ...
    },
    {
      ...
      effect:'Преимущество при подъёме, перетаскивании и удержании груза · преимущество удержаться на скользкой рабочей поверхности',
      effects:[
        {id:'labor-lift',type:'world',trigger:'lift-drag-carry-or-hold-load',operation:'grant-advantage',value:1,condition:'manual-cargo-or-heavy-labor',frequency:'passive',stacking:'highest'},
        {id:'wet-footing',type:'defense',trigger:'resist-prone',operation:'grant-advantage',value:1,condition:'wet-oily-or-otherwise-slippery-work-surface',frequency:'passive',stacking:'highest'}
      ],
  ...
  var WEAPON_ITEMS = [
    ...
    {
      id:'shp_weapon_33', name:'Кинжал канатного мастера', icon:'🗡️', image:'images/shop/dagger-ropewright.png', imageThumb:'images/shop/thumbs/dagger-ropewright.jpg',
      rarity:'common', powerTier:1, levels:[1,5], markets:['local-open','city'], legality:'open', price:{pl:0,zl:7,sr:0,md:0}, hands:1,
      damage:'1d4', damageType:'Колющий', range:'Ближняя / 1 клетка', tags:['dagger','knife','melee','tool','concealable'], baseRegion:'root-valley', marketIds:['morelesie-lighthouse-market','glupishche-last-rest'],
      effect:'Рабочий клинок · уверенно режет канат, парусину и сыромятные ремни', effects:[{id:'ropewright-work-blade',type:'world',trigger:'cut-accessible-ordinary-rope-canvas-or-rawhide',operation:'cut-work-material-without-damaging-tool',value:1,condition:'material-is-ordinary-and-not-under-dangerous-tension',frequency:'passive',stacking:'unique-source'}],
      desc:'Широкое короткое лезвие, загнутая пятка и пробковая рукоять не скользят в мокрой ладони. В Морелесье таким ножом сначала режут снасть, а уже потом защищаются.'
    },
    {
      id:'shp_weapon_34', name:'Сапожный кинжал дорожной стражи', icon:'🗡️', image:'images/shop/dagger-road-guard.png', imageThumb:'images/shop/thumbs/dagger-road-guard.jpg',
      rarity:'common', powerTier:1, levels:[1,5], markets:['city','licensed'], legality:'open', price:{pl:0,zl:9,sr:0,md:0}, hands:1,
      damage:'1d4', damageType:'Колющий', range:'Ближняя / 1 клетка', tags:['dagger','knife','melee','concealable'], baseRegion:'upperland', marketIds:['dorogograd-golden-measure','glupishche-last-rest'],
      effect:'Узкий запасной клинок · помещается в голенище или плоские ножны', effects:[{id:'road-guard-flat-carry',type:'world',trigger:'store-dagger-in-compatible-boot-or-flat-sheath',operation:'carry-low-profile-backup-weapon',value:1,condition:'compatible-sheath;does-not-conceal-from-deliberate-search',frequency:'passive',stacking:'unique-source'}],
      desc:'Прямой четырёхгранный клинок с низкой гардой. Его носят там, где длинное оружие пришлось оставить у двери.'
    },
    {
      id:'shp_weapon_35', name:'Метательный лист Морелесья', icon:'🔪', image:'images/shop/dagger-moreles-throwing-leaf.png', imageThumb:'images/shop/thumbs/dagger-moreles-throwing-leaf.jpg',
      rarity:'uncommon', powerTier:1, levels:[1,6], markets:['city','guild'], legality:'restricted', price:{pl:1,zl:4,sr:0,md:0}, hands:1,
      damage:'1d4', damageType:'Колющий', range:'Дальняя / 5 клеток', tags:['dagger','knife','ranged','thrown','concealable'], baseRegion:'root-valley', marketIds:['morelesie-lighthouse-market','glupishche-last-rest'],
      effect:'Тяжёлый листовидный клинок, сбалансированный для броска на короткой дистанции', effects:[{id:'moreles-throwing-leaf-balance',type:'scouting',trigger:'inspect-or-recover-thrown-leaf',operation:'identify-balanced-throwing-orientation',value:1,condition:'ordinary-light-and-weapon-reachable',frequency:'passive',stacking:'unique-source'}],
      desc:'Клинок расширяется к острию, а плоская рукоять заканчивается свинцовым кольцом. Хороший бросок требует навыка, не тайной пружины или чар.'
    },
    {
      id:'shp_weapon_36', name:'Кинжал «Тихий долг»', icon:'🗡️', image:'images/shop/dagger-silent-debt.png', imageThumb:'images/shop/thumbs/dagger-silent-debt.jpg',
      rarity:'rare', powerTier:2, levels:[3,7], markets:['guild','secret'], legality:'restricted', price:{pl:9,zl:0,sr:0,md:0}, hands:1,
      damage:'1d4', damageType:'Колющий', range:'Ближняя / 1 клетка', tags:['dagger','knife','melee','concealable','ambush'], baseRegion:'levoshlak', marketIds:['strannograd-bog-guild','levoshlak-tower-vault'],
      effect:'Раз за сцену · попадание из скрытности лишает цель реакции до начала её следующего хода',
      effects:[{id:'silent-debt-open-guard',type:'control',trigger:'hit-from-hidden',operation:'disable-reaction',balanceOperation:'artifact-effect',value:2,duration:'until-target-next-turn-start',frequency:'scene',stacking:'refresh'}],
      desc:'Матовый узкий клинок с утопленной гардой не цепляется за одежду и почти не отражает свет. Долг он не взыскивает сам — лишь оставляет противнику слишком мало времени на ответ.'
    },
    {
      id:'shp_weapon_37', name:'Кинжал «Стеклянный отлив»', icon:'◇', image:'images/shop/dagger-glass-ebb.png', imageThumb:'images/shop/thumbs/dagger-glass-ebb.jpg',
      rarity:'epic', powerTier:2, levels:[4,8], markets:['licensed','secret'], legality:'restricted', price:{pl:28,zl:0,sr:0,md:0}, hands:1,
      damage:'1d6', damageType:'Колющий', range:'Ближняя / 1 клетка', tags:['dagger','knife','melee','masterwork','relic','levoshlak'], baseRegion:'levoshlak', marketIds:['levoshlak-tower-vault','morelesie-lighthouse-market'],
      requirements:[{stat:'dexterity',min:4}], effect:'Раз за сцену после попадания брось кубик урона кинжала дважды и оставь лучший результат · реликтовая кромка усиливает числовой эффект на 20%',
      effects:[{id:'glass-ebb-perfect-edge',type:'damage',trigger:'hit',operation:'damage-roll-advantage',balanceOperation:'artifact-effect',value:1,frequency:'scene',stacking:'highest'}],
      desc:'Безупречно сведённый клинок из тёмной стали несёт вдоль кромки тонкую полосу дымчатого морского стекла. Это не украшение: мастера Левошлака считают его мерой идеальной заточки.'
    }
  ].map(function (item) {
    item.schemaVersion = SCHEMA_VERSION;
    item.definitionVersion = 1;
  ...
  var ARMOR_AND_CLOTHING_ITEMS = [
    ...
    },
    {
      ...
      access:{markets:['local-open','city'],legality:'open'}, price:{pl:0,zl:5,sr:0,md:0},
      effect:'Преимущество при уходе, успокоении и первой помощи обычному домашнему или дрессированному животному вне боя',
      effects:[{id:'stable-work',type:'world',trigger:'handle-care-or-first-aid-trained-animal',operation:'grant-advantage',value:1,condition:'outside-combat;ordinary-domestic-or-trained-animal',frequency:'passive',stacking:'highest'}],
    ...
    },
    {
      ...
      effect:'Преимущество при чтении договора, точном копировании и поиске противоречий или следов подделки в известном письме',
      effects:[{id:'scribe-work',type:'world',trigger:'read-copy-audit-or-recall-written-document',operation:'grant-advantage',value:1,condition:'document-is-nonmagical-and-language-is-known',frequency:'passive',stacking:'highest'}],
  ...
  // Трактирная еда привязана к месту и цене местного рынка, а не копирует
  // цены из заметок ведущего. Бонусы бытовые: блюдо помогает в дороге или
  // отдыхе, но не становится обязательным боевым расходником.
  var TAVERN_FOOD_ITEMS = [
    {id:'shp_food_01',name:'Угорь в луковой корке Морелесья',icon:'🐟',image:'images/shop/food-moreles-eel.png',imageThumb:'images/shop/thumbs/food-moreles-eel.jpg',foodKind:'hot-meal',servings:1,powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:1,md:8},effect:'Сытная горячая порция · после еды легче переносится обычная сырость до следующего отдыха',desc:'Жирного угря обжаривают с луком, морской солью и травами у маячного рынка.',effects:[{id:'moreles-eel-wet-weather',type:'world',trigger:'finish-hot-meal',operation:'ignore-first-ordinary-wet-weather-discomfort',value:1,duration:'until-rest',frequency:'charge',charges:1,stacking:'replace'}],baseRegion:'root-valley',marketIds:['morelesie-lighthouse-market']},
    {id:'shp_food_02',name:'Котелок маячного рыбака',icon:'🥣',image:'images/shop/food-lighthouse-stew.png',imageThumb:'images/shop/thumbs/food-lighthouse-stew.jpg',foodKind:'hot-meal',servings:1,powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:1,md:2},effect:'Горячая похлёбка считается полноценной едой и согревает после обычного промокания',desc:'Рыба, коренья и сушёные водоросли варятся до густоты, удобной для качающейся палубы.',effects:[{id:'lighthouse-stew-warmth',type:'world',trigger:'eat-after-getting-wet',operation:'remove-ordinary-chill-from-wet-clothes',value:1,frequency:'charge',charges:1,stacking:'replace'}],baseRegion:'root-valley',marketIds:['morelesie-lighthouse-market']},
    {id:'shp_food_03',name:'Свёрток копчёного отлива',icon:'🎒',image:'images/shop/food-smoked-tide-pack.png',imageThumb:'images/shop/thumbs/food-smoked-tide-pack.jpg',foodKind:'travel-ration',servings:2,powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:3,md:5},effect:'Две дорожные порции · не портятся десять дней при сухой упаковке',desc:'Копчёная рыба, твёрдый сыр и морские сухари завёрнуты раздельно в промасленную ткань.',effects:[{id:'smoked-tide-rations',type:'world',trigger:'consume-travel-ration',operation:'supply-ration-serving',value:1,frequency:'charge',charges:2,stacking:'replace'}],baseRegion:'root-valley',marketIds:['morelesie-lighthouse-market','glupishche-root-post']},
    {id:'shp_food_04',name:'Похлёбка случайного котла',icon:'🍲',image:'images/shop/food-village-mystery-stew.png',imageThumb:'images/shop/thumbs/food-village-mystery-stew.jpg',foodKind:'hot-meal',servings:1,powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:0,md:6},effect:'Дешёвая горячая еда · утоляет обычный голод без дополнительного эффекта',desc:'Крупа, коренья и мясо сегодняшнего происхождения. В деревне Эбатьэтогденск не задают лишних вопросов котлу.',effects:[{id:'village-mystery-stew-meal',type:'world',trigger:'finish-meal',operation:'satisfy-ordinary-hunger',value:1,frequency:'charge',charges:1,stacking:'replace'}],baseRegion:'root-valley',marketIds:['glupishche-last-rest']},
    {id:'shp_food_05',name:'Луковые лепёшки дальней межи',icon:'🫓',image:'images/shop/food-onion-road-cakes.png',imageThumb:'images/shop/thumbs/food-onion-road-cakes.jpg',foodKind:'travel-ration',servings:3,powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:1,md:4},effect:'Три простые дорожные порции · сохраняются четыре дня',desc:'Плотные солёные лепёшки пахнут луком сильнее, чем трактовой пылью.',effects:[{id:'onion-road-cakes-rations',type:'world',trigger:'consume-travel-ration',operation:'supply-ration-serving',value:1,frequency:'charge',charges:3,stacking:'replace'}],baseRegion:'root-valley',marketIds:['glupishche-last-rest','glupishche-root-post']},
    {id:'shp_food_06',name:'Пирог под третью песню',icon:'🥧',image:'images/shop/food-third-song-pie.png',imageThumb:'images/shop/thumbs/food-third-song-pie.jpg',foodKind:'hot-meal',servings:2,powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:2,md:5},effect:'Две сытные порции · разделённый пирог помогает расположить к себе дружескую компанию за столом',desc:'Баранина, лук и пряные травы под толстой коркой из кухни таверны «Выпей и Пой».',effects:[{id:'third-song-pie-company',type:'world',trigger:'share-meal-with-nonhostile-company',operation:'grant-advantage',value:1,condition:'first-friendly-table-conversation',frequency:'charge',charges:1,stacking:'replace'}],baseRegion:'root-valley',marketIds:['glupishche-last-rest']},
    {id:'shp_food_07',name:'Рацион бродячей труппы',icon:'🎒',image:'images/shop/food-travelling-troupe-ration.png',imageThumb:'images/shop/thumbs/food-travelling-troupe-ration.jpg',foodKind:'travel-ration',servings:2,powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:2,md:8},effect:'Две дорожные порции · упаковка раскрывается тихо и не требует посуды',desc:'Лепёшка, мягкий сыр и сушёное мясо уложены в тканевый карман, который артисты носят за поясом.',effects:[{id:'troupe-ration-quiet-meal',type:'world',trigger:'consume-travel-ration',operation:'supply-ration-serving-without-fire-or-utensils',value:1,frequency:'charge',charges:2,stacking:'replace'}],baseRegion:'root-valley',marketIds:['glupishche-last-rest','glupishche-root-post']},
    {id:'shp_food_08',name:'Медовые груши певчего двора',icon:'🍐',image:'images/shop/food-honeyed-singer-pears.png',imageThumb:'images/shop/thumbs/food-honeyed-singer-pears.jpg',foodKind:'dessert',servings:2,powerTier:0,rarity:'uncommon',price:{pl:0,zl:0,sr:2,md:0},effect:'Две десертные порции · смягчают осипший от обычной нагрузки голос до отдыха',desc:'Грушевые дольки томят в тёмном мёде и подают в маленькой глиняной чаше.',effects:[{id:'singer-pears-voice',type:'support',trigger:'eat-after-ordinary-voice-strain',operation:'remove-ordinary-hoarseness',value:1,duration:'until-rest',frequency:'charge',charges:2,stacking:'replace'}],baseRegion:'root-valley',marketIds:['glupishche-last-rest']}
  ].map(function(item){return finishBatchItem(item,{cat:'food',category:'consumable',slot:'consumable',tags:['food',item.foodKind],access:{markets:['local-open','city'],legality:'open'}});});

  var MEDICAL_REMEDY_ITEMS = [
    {id:'shp_remedy_01',name:'Мятная соль спокойного желудка',icon:'🌿',image:'images/shop/remedy-mint-stomach-salt.png',imageThumb:'images/shop/thumbs/remedy-mint-stomach-salt.jpg',remedyKind:'antidote',powerTier:1,rarity:'common',price:{pl:0,zl:1,sr:5,md:0},charges:1,effect:'Снимает обычную тошноту и позволяет сразу повторить проверку против съеденного слабого яда',desc:'Мятная соль из аптек Глупища растворяется в тёплой воде. Сильный, неизвестный или магический яд она не нейтрализует.',effects:[{id:'mint-stomach-salt',type:'support',trigger:'consume-while-nauseated-or-after-weak-ingested-poison',operation:'remove-ordinary-nausea-and-repeat-save',value:1,condition:'ordinary-nausea-or-known-weak-ingested-poison',frequency:'charge',charges:1,stacking:'replace'}]},
    {id:'shp_remedy_02',name:'Капли после внутреннего звона',icon:'💧',image:'images/shop/remedy-clear-bell-drops.png',imageThumb:'images/shop/thumbs/remedy-clear-bell-drops.jpg',remedyKind:'clarity',powerTier:1,rarity:'uncommon',price:{pl:0,zl:2,sr:5,md:0},charges:1,effect:'После удара по голове позволяет повторить спасбросок от обычного замешательства или оглушения',desc:'Горькие прозрачные капли возвращают внимание, но не лечат рану и не снимают магический контроль.',effects:[{id:'clear-bell-drops',type:'support',trigger:'consume-after-physical-head-trauma',operation:'repeat-save-against-confusion-or-stun',value:1,condition:'effect-caused-by-physical-impact;does-not-heal',frequency:'charge',charges:1,stacking:'replace'}]},
    {id:'shp_remedy_03',name:'Имбирный подъём портового лекаря',icon:'🫚',image:'images/shop/remedy-ginger-lift.png',imageThumb:'images/shop/thumbs/remedy-ginger-lift.jpg',remedyKind:'restorative',powerTier:1,rarity:'common',price:{pl:0,zl:1,sr:8,md:0},charges:1,effect:'На одну сцену убирает обычную слабость от похмелья или уже завершившегося лёгкого отравления',desc:'Острый имбирный эликсир помогает встать на ноги, но не прекращает действующий яд и не восстанавливает HP.',effects:[{id:'ginger-lift-recovery',type:'support',trigger:'consume-after-hangover-or-ended-minor-poison',operation:'suppress-ordinary-recovery-weakness',value:1,duration:'scene',condition:'poison-effect-already-ended;does-not-heal',frequency:'charge',charges:1,stacking:'replace'}]},
    {id:'shp_remedy_04',name:'Грудной бальзам «Свободный берег»',icon:'🫙',image:'images/shop/remedy-free-shore-balm.png',imageThumb:'images/shop/thumbs/remedy-free-shore-balm.jpg',remedyKind:'respiratory',powerTier:1,rarity:'common',price:{pl:0,zl:1,sr:2,md:0},charges:2,effect:'На час даёт преимущество против кашля и затруднённого дыхания от обычной простуды',desc:'Смоляной бальзам с морской солью втирают в грудь и виски. Дым, удушение и магическую болезнь он не отменяет.',effects:[{id:'free-shore-breathing',type:'defense',trigger:'apply-balm',operation:'grant-advantage',value:1,duration:'one-hour',condition:'ordinary-cold-cough-or-congestion;not-smoke-or-suffocation',frequency:'charge',charges:2,stacking:'refresh'}]},
    {id:'shp_remedy_05',name:'Перевязь авантюриста «Три узла»',icon:'🩹',image:'images/shop/remedy-three-knot-bandage.png',imageThumb:'images/shop/thumbs/remedy-three-knot-bandage.jpg',remedyKind:'first-aid',powerTier:1,rarity:'uncommon',price:{pl:0,zl:4,sr:0,md:0},charges:3,effect:'Коротким действием автоматически останавливает обычное кровотечение · 3 применения',desc:'Три стерильные перевязи, давящие подушки и деревянные закрутки уложены по порядку применения. Потерянные HP они не возвращают.',effects:[{id:'three-knot-stop-bleeding',type:'healing',trigger:'apply-bandage-to-ordinary-bleeding',operation:'stop-ordinary-bleeding',value:1,actionCost:'short',condition:'target-reachable;does-not-restore-hp',frequency:'charge',charges:3,stacking:'replace'}]},
    {id:'shp_remedy_06',name:'Экстракт тихой боли',icon:'🧪',image:'images/shop/remedy-quiet-pain-extract.png',imageThumb:'images/shop/thumbs/remedy-quiet-pain-extract.jpg',remedyKind:'painkiller',powerTier:2,rarity:'uncommon',price:{pl:0,zl:5,sr:5,md:0},charges:1,effect:'На час игнорирует помеху от одного обычного ранения · не лечит и не скрывает ухудшение раны',desc:'Тёмный экстракт делает боль далёкой, поэтому лекарь всегда привязывает к бутылке красную предупредительную нить.',effects:[{id:'quiet-pain-extract',type:'support',trigger:'consume-with-ordinary-wound',operation:'ignore-one-wound-disadvantage',value:1,duration:'one-hour',condition:'ordinary-wound;does-not-heal-or-prevent-worsening',frequency:'charge',charges:1,stacking:'replace'}]},
    {id:'shp_remedy_07',name:'Мазь «Серебряный шов»',icon:'🫙',image:'images/shop/remedy-silver-seam-salve.png',imageThumb:'images/shop/thumbs/remedy-silver-seam-salve.jpg',remedyKind:'wound-treatment',powerTier:3,rarity:'rare',price:{pl:2,zl:8,sr:0,md:0},charges:1,effect:'Долгим действием снимает одно обычное ранение · не возвращает HP и не восстанавливает утраченную часть тела',desc:'Редкая серебристая мазь стягивает чистые края раны. Загрязнённую или проклятую рану сперва должен обработать лекарь.',effects:[{id:'silver-seam-salve',type:'healing',trigger:'apply-to-clean-ordinary-wound',operation:'remove-one-ordinary-wound',value:1,actionCost:'long',condition:'clean-wound;not-curse-disease-or-amputation;does-not-restore-hp',frequency:'charge',charges:1,stacking:'replace'}]},
    {id:'shp_remedy_08',name:'Настойка ровного голоса',icon:'☀️',image:'images/shop/remedy-steady-voice-tincture.png',imageThumb:'images/shop/thumbs/remedy-steady-voice-tincture.jpg',remedyKind:'composure',powerTier:2,rarity:'uncommon',price:{pl:0,zl:6,sr:0,md:0},charges:1,effect:'Позволяет повторить один проваленный спасбросок от Страха или обычной паники',desc:'Тёплая настойка возвращает дыханию ритм. Она не даёт иммунитет и не помогает против приказа, проклятия или иного контроля.',effects:[{id:'steady-voice-fear-save',type:'support',trigger:'consume-after-failed-fear-or-panic-save',operation:'repeat-save-against-fear-or-ordinary-panic',value:1,condition:'one-failed-save;not-other-control',frequency:'charge',charges:1,stacking:'replace'}]}
  ].map(function(item){item.consumption={mode:'consume-on-use'};return finishBatchItem(item,{cat:'potion',category:'consumable',slot:'consumable',tags:['medicine',item.remedyKind],access:{markets:item.rarity==='rare'?['guild','licensed']:['city','guild'],legality:'open'}});});
  ...
  var SERVICE_ITEMS = [
    ...
    {id:'shp_service_13',name:'Баня, стирка и просушка дорожного комплекта',image:'images/shop/service-bath-laundry.png',imageThumb:'images/shop/thumbs/service-bath-laundry.jpg',serviceKind:'traveler-care',powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:6,md:0},effect:'Снимает обычную грязь, промокание и дорожный запах с героя и одного комплекта одежды',desc:'Горячая вода, щёлочное мыло, сушильная комната и мелкий ремонт швов. Болезнь, яд и магическое загрязнение требуют отдельной услуги.',effects:[{id:'bath-laundry-travel-care',type:'world',trigger:'complete-bath-and-laundry-service',operation:'remove-ordinary-dirt-wetness-and-travel-odor',value:1,condition:'one-person-and-one-clothing-set',frequency:'charge',charges:1,stacking:'replace'}],baseRegion:'zargota-all',marketIds:['glupishche-last-rest','dorogograd-golden-measure']},
    {id:'shp_service_14',name:'Упаковка горячей кухни в дорогу',image:'images/shop/service-road-meal-packing.png',imageThumb:'images/shop/thumbs/service-road-meal-packing.jpg',serviceKind:'ration-packing',powerTier:0,rarity:'common',price:{pl:0,zl:0,sr:8,md:0},effect:'Превращает до трёх купленных порций подходящей еды в сухие дорожные свёртки на три дня',desc:'Повар охлаждает начинку, разделяет порции и запечатывает их промасленной бумагой. Цена еды оплачивается отдельно.',effects:[{id:'road-meal-packing-service',type:'world',trigger:'complete-food-packing-service',operation:'convert-meals-to-three-day-rations',value:3,condition:'up-to-three-compatible-purchased-meals',frequency:'charge',charges:1,stacking:'replace'}],baseRegion:'root-valley',marketIds:['morelesie-lighthouse-market','glupishche-last-rest']},
    {id:'shp_service_15',name:'Проверка припасов перед трактом',image:'images/shop/service-expedition-check.png',imageThumb:'images/shop/thumbs/service-expedition-check.jpg',serviceKind:'expedition-inspection',powerTier:0,rarity:'common',price:{pl:0,zl:1,sr:5,md:0},effect:'Находит одну явную нехватку или неисправность в припасах группы для выбранного маршрута',desc:'Опытный кладовщик сверяет воду, еду, крепёж, свет, укрытие и запасные детали с погодой и дорогой. Скрытую угрозу маршрута он не предсказывает.',effects:[{id:'expedition-supply-inspection',type:'scouting',trigger:'complete-predeparture-inspection',operation:'reveal-one-obvious-supply-gap-or-fault',value:1,condition:'declared-route-and-packed-gear-visible',frequency:'charge',charges:1,stacking:'replace'}],baseRegion:'zargota-all',marketIds:['glupishche-last-rest','glupishche-root-post','dorogograd-golden-measure']},
    {id:'shp_service_16',name:'Ночная дверь «Последнего Привала»',image:'images/shop/service-last-rest-night-door.png',imageThumb:'images/shop/thumbs/service-last-rest-night-door.jpg',serviceKind:'after-hours-trade',powerTier:0,rarity:'uncommon',price:{pl:0,zl:5,sr:0,md:0},effect:'Открывает лавку Глупища ночью для одной срочной законной покупки из имеющегося запаса',desc:'Охранник поднимает Симура и впускает группу через заднюю дверь. Плата не заменяет цену товара, не создаёт отсутствующий товар и не даёт права торговаться.',effects:[{id:'last-rest-after-hours-access',type:'world',trigger:'pay-after-hours-access',operation:'open-one-emergency-legal-shopping-visit',value:1,condition:'stock-on-hand;no-forbidden-goods;item-price-separate',frequency:'charge',charges:1,stacking:'replace'}],baseRegion:'root-valley',marketIds:['glupishche-last-rest']}
  ].map(function(item){
    item.icon='🤝';
  ...
  function enrichShopItem(item) {
    ...
    if (enriched.rarity === 'epic') {
      enriched.relicPowerMultiplier = 1.2;
      enriched.effects = Array.isArray(enriched.effects) ? enriched.effects.slice() : [];
      if (!enriched.effects.some(function(effect){ return effect && effect.id === 'relic-quality-scale'; })) {
        enriched.effects.push({id:'relic-quality-scale',type:'support',trigger:'resolve-item-numeric-effect',operation:'multiply-item-numeric-effect',multiplier:1.2,rounding:'up',frequency:'passive',stacking:'replace'});
      }
    }
    return enriched;
  }
  ...
  function validateServiceItems() {
    ...
    if (SERVICE_ITEMS.length !== 16) errors.push('services: expected sixteen items');
  ...
  return {
    ...
    getTavernFoodItems:function () { return clone(TAVERN_FOOD_ITEMS); },
    getMedicalRemedyItems:function () { return clone(MEDICAL_REMEDY_ITEMS); },
